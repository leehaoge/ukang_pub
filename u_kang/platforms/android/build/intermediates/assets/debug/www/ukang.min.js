...
define('core/date-utils',[], function () {
    /**
     * 日期格式化和解析
...
define('core/core',['core/context', 'core/date-utils'], function(context, dateUtils) {
    'use strict';
...
/* 数据仓库 */
define('core/data-store',[], function() {
    'use strict';
 ...
 * 各种常数
 */
define('ukang-constants',[], function () {
...
define('ukang-utils',['core/date-utils', 'ukang-constants'], function (DateUtils, CONSTS) {
    'use strict';
...
define('core/sqlite-utils',[], function () {
    'use strict';
...
define('prepare-db',['ukang-sqlite', 'core/sqlite-utils', 'ukang-constants', 'core/context'],
...
define('core/mock-data',['core/core'], function (CORE) {
    'use strict';
...
define('app-datas',['core/context', 'core/data-store', 'core/mock-data', 'ukang-constants', 'ukang-sqlite', 'ukang-utils'],
    function (context, dataStore, MockData, CONSTS, sqlite, utils) {
        ...
        if (window.app.inDevice) {
                        ...
                        set: function() {
                            ...
                            function add() {
                                var sql = "INSERT INTO " + tbName + " (\
                                    user_id, u_name, birthday, age, weight, height, blood_type, medical_memo, allergies, \
                                    medicines) VALUES (?,?,?,?,?,?,?,?,?,?)";
                                db.executeSql(sql, [data['id'], data['name'], data['birthdaty'], data['age'],
                                    data['weight'], data['height'], data['bloodType'], data['medical_memo'], 
                                    data['allergies', data['medicines']]], function() {
                                    executeCallback(onSuccess);
                                }, function (error) {
            ...
            //APP用户:
            var appUsers = [
                { id: '13500000217', name: '浩哥', birthday: '1973-02-27', age: 44, weight: 80, height: 173, bloodType: 'O', 
                    medicalMemo: '', //医疗状况
                    allergies: '',   //过敏反应
                    medicines: '',   //药物使用
 ...
 * APP数据逻辑处理 
 **/
define('ukang-app',['core/context', 'core/data-store', 'ukang-utils', 'ukang-constants', 'prepare-db'],
...
define('core/fragment',['core/core'], function(CORE) {
    'use strict';
...
define('text!html/healthcard.html',[],function () { return '<div class="ui-grid-b uk-nav-bar">\r\n    <div class="ui-block-a">\r\n        <a href="#" class="uk-link-2">\r\n            &nbsp;\r\n            <img src="img/calendar.png">&nbsp;</a>\r\n    </div>\r\n    <div class="ui-block-b text-center uk-frame-title">\r\n        健康数据\r\n    </div>\r\n    <div class="ui-block-c text-right">\r\n        <a href="#" class="uk-link-2">\r\n            &nbsp;\r\n            <img src="img/user-hd.png">&nbsp;</a>\r\n    </div>\r\n</div>\r\n<div class="uk-module-frame">\r\n    <div id="hc-main-pane">\r\n    </div>\r\n</div>';});

define('core/base-module',['core/core', 'core/fragment', 'core/context'], function(CORE, Fragment, context) {
    'use strict';
...
define('text!html/datapage.html',[],function () { return '<div class="ui-grid-b uk-nav-bar">\r\n    <div class="ui-block-a">\r\n        <a id="ln-hc-main" href="#" class="uk-link-1">\r\n            <img src="img/carat-l-red.png">返回</a>\r\n    </div>\r\n    <div class="ui-block-b text-center uk-frame-title">\r\n        <%=dataName%>\r\n    </div>\r\n    <div class="ui-block-c text-right">\r\n        <a id="ln-data-input" href="#" class="uk-link-1">&nbsp;\r\n            <img src="img/plus-red.png">&nbsp;</a>\r\n    </div>\r\n\r\n</div>\r\n<div class="uk-module-frame">\r\n\r\n    <div class="sep_v_5"></div>\r\n    <div class="ui-grid-c ui-corner-all uk-thin-border-red uk-data-period">\r\n        <div class="ui-block-a text-center uk-period-block uk-data-period-selected">日\r\n        </div>\r\n        <div class="ui-block-b text-center uk-period-block uk-period-block-border">周\r\n        </div>\r\n        <div class="ui-block-c text-center uk-period-block uk-period-block-border">月\r\n        </div>\r\n        <div class="ui-block-d text-center uk-period-block uk-period-block-border">年\r\n        </div>\r\n\r\n    </div>\r\n    <div class="sep_v_5"></div>\r\n    <div class="ui-body-a ui-corner-all">\r\n        <canvas id="data-chart" class="uk-data-chart"></canvas>\r\n    </div>\r\n    <div class="sep_v_5"></div>\r\n    <div>\r\n        <ul data-role="listview" data-inset="true">\r\n            <li data-icon="false">\r\n                <a href="#">添加到个人收藏\r\n                    <div class="uk-right-op text-right">\r\n                        <select id="sw-collect" data-role="slider" data-mini="true">\r\n                            <option value="off" selected></option>\r\n                            <option value="on"></option>\r\n                        </select>\r\n                    </div>\r\n                </a>\r\n                <!-- <div class="uk-with-right-op">添加到个人收藏</div> -->\r\n            </li>\r\n            <li>\r\n                <a id="ln-show-data" href="#">显示所有数据\r\n                    <p class="ui-li-aside"></p>\r\n                </a>\r\n            </li>\r\n            <li>\r\n                <a href="#">单位\r\n                    <p class="ui-li-aside">\r\n                        <%=unitDisp%>\r\n                    </p>\r\n                </a>\r\n            </li>\r\n        </ul>\r\n    </div>\r\n</div>';});
...
define('text!html/datainput.html',[],function () { return '<div class="ui-grid-b uk-nav-bar">\r\n    <div class="ui-block-a">\r\n        <a id="ln-hc-main" href="#app_main_page" class="uk-link-1">\r\n            <img src="img/carat-l-red.png">取消</a>\r\n    </div>\r\n    <div class="ui-block-b text-center uk-frame-title">\r\n        <span data-id="dataName">\r\n            <%=dataName%>\r\n        </span>\r\n    </div>\r\n    <div class="ui-block-c text-right">\r\n        <a href="#" class="uk-link-1" id="ln-di-add">添加</a>\r\n    </div>\r\n\r\n</div>\r\n<div id="uk-di-frame" class="uk-module-frame">\r\n\r\n    <div class="sep_v_10"></div>\r\n    <ul data-role="listview">\r\n        <li>\r\n            <div class="ui-grid-a">\r\n                <div class="ui-block-a">日期\r\n                </div>\r\n                <div class="ui-block-b text-right">\r\n                    <input type="date" id="di-sample-date" data-id="sampleDate" class="uk-flat-input uk-mini-input text-right" data-role="none"\r\n                        value="<%=today%>">\r\n                </div>\r\n        </li>\r\n        <li>\r\n            <div class="ui-grid-a">\r\n                <div class="ui-block-a">时间\r\n                </div>\r\n                <div class="ui-block-b text-right">\r\n                    <input type="time" id="di-sample-date" data-id="sampleTime" class="uk-flat-input uk-mini-input text-right" data-role="none"\r\n                        value="<%=nowtime%>">\r\n                </div>\r\n        </li>\r\n        <li>\r\n            <div class="ui-grid-a">\r\n                <div class="ui-block-a">数据\r\n                </div>\r\n                <div class="ui-block-b text-right">\r\n                    <input type="number" data-id="value1" class="uk-flat-input uk-mini-input text-right" data-role="none" value="">\r\n                </div>\r\n            </div>\r\n        </li>\r\n    </ul>\r\n\r\n    </div>';});

define('data-input',['text!html/datainput.html', 'core/fragment', 'core/core', 'ukang-utils', 'ukang-app'], function (tpl, Fragment, CORE, utils, ukApp) {
    'use strict';
...
define('pop-page',['data-input'], function (dataInput) {
    'use strict';
...
define('data-page',['text!html/datapage.html', 'core/fragment', 'ukang-app', 'chart', 'pop-page'],
...
define('text!html/datalist.html',[],function () { return '<div class="ui-grid-b uk-nav-bar">\r\n    <div class="ui-block-a">\r\n        <a id="ln-to-data" href="#" class="uk-link-1">\r\n            <img src="img/carat-l-red.png"><%=dataName%>\r\n        </a>\r\n    </div>\r\n    <div class="ui-block-b text-center uk-frame-title">\r\n        所有已记录的数据\r\n    </div>\r\n    <div class="ui-block-c text-right">\r\n        <a id="ln-datalist-edit" href="#" class="uk-link-1">编辑</a>\r\n    </div>\r\n\r\n</div>\r\n\r\n<div class="uk-module-frame">\r\n\r\n    <div class="sep_v_10"></div>\r\n\r\n    <div id="nodata-pane" class="hidden">\r\n        <div class="uk-nodata-0 center-text">\r\n            无数据\r\n        </div>\r\n    </div>\r\n    <div id="datalist-pane" class="hidden">\r\n        <div>\r\n            <%=unitDisp%>\r\n        </div>\r\n        <div class="sep_v_5"></div>\r\n        <ul id="datalist-ul" data-role="listview">\r\n\r\n        </ul>\r\n    </div>\r\n</div>';});

define('data-list',['text!html/datalist.html', 'core/fragment', 'ukang-app'], function (tpl, Fragment, ukApp) {
    'use strict';
...
define('health-card',['text!html/healthcard.html', 'ukang-app', 'core/core', 'core/fragment', 'core/base-module', 'data-page', 'data-list'],
    function (tpl, ukApp, CORE, Fragment, BaseModule, dataPage, dataList) {
        'use strict';
...
define('text!html/healthcenter.html',[],function () { return '<div class="ui-grid-b uk-nav-bar">\r\n    <div class="ui-block-a">\r\n        <a id="ln-hc-main" href="#" class="uk-link-1">&nbsp;</a>\r\n    </div>\r\n    <div class="ui-block-b text-center uk-frame-title">&nbsp;</div>\r\n    <div class="ui-block-c text-right">\r\n        <a id="ln-health-notice" href="#" class="uk-link-2">&nbsp;\r\n            <img src="img/chat-hd.png">&nbsp;</a>\r\n    </div>\r\n\r\n</div>\r\n<div class="uk-module-frame">\r\n\r\n\r\n    <h1>健康中心</h1>\r\n\r\n    <p>\r\n        <input type="search" value="">\r\n    </p>\r\n\r\n    <ul class="ukang-health-center">\r\n        <li class="uk-hc-solution">解决方案</li>\r\n        <li class="uk-hc-article">专家讲堂</li>\r\n        <li class="uk-hc-hints">健康提示</li>\r\n        <li class="uk-hc-shop">U康商城</li>\r\n\r\n    </ul>\r\n\r\n</div>';});


define('text!html/healthnotice.html',[],function () { return '<div class="ui-grid-b uk-nav-bar">\r\n    <div class="ui-block-a">\r\n        <a id="ln-health-center" href="#" class="uk-link-1">\r\n            <img src="img/carat-l-red.png">健康中心\r\n        </a>\r\n    </div>\r\n    <div class="ui-block-b text-center uk-frame-title">\r\n        通知\r\n    </div>\r\n    <div class="ui-block-c text-right">\r\n    </div>\r\n\r\n</div>\r\n\r\n<div class="uk-module-frame">\r\n    <div class="sep_v_5"></div>\r\n    <ul data-role="listview">\r\n        <h2>星期六</h2>\r\n        <li data-icon="false"><a href="#">健康提示：七招教你饭后控制血糖</a></li>\r\n        <li data-icon="false"><a href="#">专家讲堂：刘教授：如何有效控制血糖</a></li>\r\n    </ul>\r\n    <div class="sep_v_20"></div>\r\n    <ul data-role="listview">\r\n        <h2>星期二</h2>\r\n        <li data-icon="false"><a href="#">健康提示：血糖有哪些简单的控制方法？</a></li>\r\n    </ul>\r\n    <div class="sep_v_20"></div>\r\n    <ul data-role="listview">\r\n        <h2>更早</h2>\r\n        <li data-icon="false"><a href="#">健康提示：四招教你稳定降压</a></li>\r\n    </ul>\r\n</div>';});

define('health-notice',['text!html/healthnotice.html', 'core/fragment', 'ukang-app'], function(tpl, Fragment, ukApp) {
    'use strict';
...
define('text!html/solutions.html',[],function () { return '<div class="ui-grid-b uk-nav-bar">\r\n        <div class="ui-block-a">\r\n            <a id="ln-health-center" href="#" class="uk-link-1">\r\n                <img src="img/carat-l-red.png">健康中心\r\n            </a>\r\n        </div>\r\n        <div class="ui-block-b text-center uk-frame-title">\r\n            解决方案\r\n        </div>\r\n        <div class="ui-block-c text-right">\r\n        </div>\r\n    \r\n    </div>\r\n    \r\n    <div class="uk-module-frame">\r\n    </div>';});

define('solutions',['text!html/solutions.html', 'core/fragment', 'ukang-app'], function(tpl, Fragment, ukApp) {
    'use strict';
...
define('text!html/articles.html',[],function () { return '<div class="ui-grid-b uk-nav-bar">\r\n    <div class="ui-block-a">\r\n        <a id="ln-health-center" href="#" class="uk-link-1">\r\n            <img src="img/carat-l-red.png">健康中心\r\n        </a>\r\n    </div>\r\n    <div class="ui-block-b text-center uk-frame-title">\r\n        专家讲堂\r\n    </div>\r\n    <div class="ui-block-c text-right">\r\n    </div>\r\n\r\n</div>\r\n\r\n<div class="uk-module-frame">\r\n\r\n    <p>\r\n        <input type="search" value="">\r\n    </p>\r\n\r\n\r\n</div>';});

define('articles',['text!html/articles.html', 'core/fragment', 'ukang-app'], function(tpl, Fragment, ukApp) {
    'use strict';
...
define('text!html/healthhints.html',[],function () { return '<div class="ui-grid-b uk-nav-bar">\r\n        <div class="ui-block-a">\r\n            <a id="ln-health-center" href="#" class="uk-link-1">\r\n                <img src="img/carat-l-red.png">健康中心\r\n            </a>\r\n        </div>\r\n        <div class="ui-block-b text-center uk-frame-title">\r\n            健康提示\r\n        </div>\r\n        <div class="ui-block-c text-right">\r\n        </div>\r\n    \r\n    </div>\r\n    \r\n    <div class="uk-module-frame">\r\n    \r\n        <p>\r\n            <input type="search" value="">\r\n        </p>\r\n    \r\n    \r\n    </div>';});

define('health-hints',['text!html/healthhints.html', 'core/fragment', 'ukang-app'], function(tpl, Fragment, ukApp) {
    'use strict';
...
define('text!html/ukangmall.html',[],function () { return '<div class="ui-grid-b uk-nav-bar">\r\n    <div class="ui-block-a">\r\n        <a id="ln-health-center" href="#" class="uk-link-1">\r\n            <img src="img/carat-l-red.png">健康中心\r\n        </a>\r\n    </div>\r\n    <div class="ui-block-b text-center uk-frame-title">\r\n        U康商城\r\n    </div>\r\n    <div class="ui-block-c text-right">\r\n    </div>\r\n\r\n</div>\r\n\r\n<div class="uk-module-frame">\r\n\r\n    <p>\r\n        <input type="search" value="">\r\n    </p>\r\n\r\n\r\n    <ul class="uk-mall-list">\r\n        <li class="uk-mall-item">\r\n            <div>\r\n                <img src="img/201509191720266264_small.jpg">\r\n            </div>\r\n            <div class="text-center">U康血糖仪\r\n                <br>￥268.00</div>\r\n        </li>\r\n        <li class="uk-mall-item">\r\n            <div>\r\n                <img src="img/201509191746392117_small.jpg">\r\n            </div>\r\n            <div class="text-center">U康血压计\r\n                <br>￥198.00</div>\r\n        </li>\r\n        <li class="uk-mall-item">\r\n            <div>\r\n                <img src="img/201509191732463911_small.jpg">\r\n            </div>\r\n            <div class="text-center">U康盒子\r\n                <br>￥76.00</div>\r\n        </li>\r\n        <li class="uk-mall-item">\r\n            <div>\r\n                <img src="img/201509191746392117_small.jpg">\r\n            </div>\r\n            <div class="text-center">降压冲剂\r\n                <br>￥88.00</div>\r\n        </li>\r\n    </ul>\r\n\r\n</div>';});

define('ukang-mall',['text!html/ukangmall.html', 'core/fragment', 'ukang-app'], function(tpl, Fragment, ukApp) {
    'use strict';
...
define('health-center',['text!html/healthcenter.html', 'core/base-module', 'health-notice', 'solutions', 'articles', 'health-hints', 'ukang-mall'],
...
define('text!html/datasource.html',[],function () { return '<div class="ui-grid-b uk-nav-bar">\r\n    <div class="ui-block-a">\r\n    </div>\r\n    <div class="ui-block-b text-center uk-frame-title"></div>\r\n    <div class="ui-block-c text-right">\r\n        <a id="ln-add-source" href="#" class="uk-link-2">&nbsp;\r\n            <img src="img/plus-red.png">&nbsp;</a>\r\n    </div>\r\n\r\n</div>\r\n\r\n<div class="uk-module-frame">\r\n\r\n    <h1>数据来源</h1>\r\n\r\n    <div class="sep_v_20"></div>\r\n    <div>\r\n        <div class="uk-group-title">应用</div>\r\n        <ul data-role="listview">\r\n            <li>\r\n                <a href="#">秒健康</a>\r\n            </li>\r\n            <li>\r\n                <a href="#">时钟</a>\r\n            </li>\r\n            <li>\r\n                <a href="#">随糖</a>\r\n            </li>\r\n\r\n        </ul>\r\n    </div>\r\n    <div class="sep_v_20"></div>\r\n    <div>\r\n        <div class="uk-group-title">设备</div>\r\n        <ul data-role="listview">\r\n            <li>\r\n                <a href="#">我的手机</a>\r\n            </li>\r\n            <li>\r\n                <a href="#">血压计</a>\r\n            </li>\r\n            <li>\r\n                <a href="#">体脂秤</a>\r\n            </li>\r\n\r\n        </ul>\r\n    </div>\r\n</div>';});

define('datasource',['text!html/datasource.html', 'core/base-module'], function (tpl, BaseModule) {
    'use strict';
...
define('text!html/personalcenter.html',[],function () { return '<div class="ui-grid-b uk-nav-bar">\r\n    <div class="ui-block-a">\r\n    </div>\r\n    <div class="ui-block-b text-center uk-frame-title"></div>\r\n    <div class="ui-block-c text-right">\r\n        <a id="ln-edit-person" href="#" class="uk-link-1">&nbsp;编辑&nbsp;</a>\r\n    </div>\r\n\r\n</div>\r\n\r\n\r\n<div class="uk-module-frame">\r\n    <h1>个人中心</h1>\r\n    <div id="div-person-info-disp">\r\n\r\n    </div>\r\n</div>';});


define('text!html/personalinfo.html',[],function () { return '<div class="uk-module-frame">\r\n    <div class="ui-grid-a">\r\n        <div class="ui-block-a"><a id="ln-pi-cancel" href="#" class="uk-link-1">取消</a>\r\n        </div>\r\n        <div class="ui-block-b text-right">\r\n              <a id="ln-pi-save" href="#" class="uk-link-1">保存</a>\r\n        </div>\r\n    </div>\r\n    \r\n    <div class="sep_v_20"></div>\r\n    <div>\r\n        <div class="portrait float-left"></div>\r\n        <div class="uk-input-pane-2">\r\n            <input type="text" class="uk-trail-input">\r\n\r\n        </div>\r\n    </div>\r\n    <div>\r\n        <div class="info-label-pane">体重</div>\r\n        <div class="info-unit-pane">千克</div>\r\n        <div class="info-input-pane-withunit"><input type="text" class="uk-trail-input"></div>\r\n    </div>\r\n    <div>\r\n        <div class="info-label-pane">身高</div>\r\n        <div class="info-unit-pane">厘米</div>\r\n        <div class="info-input-pane-withunit"><input type="text" class="uk-trail-input"></div>\r\n    </div>\r\n    <div>\r\n        <div class="info-label-pane">体重</div>\r\n        <div class="info-unit-pane">千克</div>\r\n        <div class="info-input-pane-withunit"><input type="text" class="uk-trail-input"></div>\r\n    </div>\r\n</div>';});

define('edit-person-info',['text!html/personalinfo.html', 'core/fragment', 'ukang-app'], function(tpl, Fragment, ukApp) {
    'use strict';
    ...
    function show(el, config) {
        var fragment = new Fragment(el);
        conf = conf || {};
        if (config) $.extend(conf, config);
        fragment.load(tpl, conf, onloaded);
    }
...
define('personal-center',['text!html/personalcenter.html', 'text!html/personalinfo.html', 'core/context', 'core/fragment', 'core/base-module', 
    'ukang-app', 'edit-person-info'], 
function (tpl, piHTML, context, Fragment, BaseModule, ukApp, editInfo) {
    'use strict';
...
define('mainframe',['core/context', 'core/fragment', 'modules'], function (context, Fragment, M) {
    'use strict';
...
define('text!html/mainframe.html',[],function () { return '<div id="app_main">\r\n<div id="mdl_health_card" class="app_module hidden"></div>\r\n<div id="mdl_health_center" class="app_module hidden"></div>\r\n<div id="mdl_datasource" class="app_module hidden"></div>\r\n<div id="mdl_personal_center" class="app_module hidden"></div>\r\n</div>\r\n';});

define('main',['core/context', 'ukang-app', 'mainframe', 'text!html/mainframe.html'],
